import Droid.*;
import Droid.DroidBercerk;
import Droid.DroidKnight;
...
public class BattleArena {
    ...
    private boolean fight(int length){
        ...
        try {
            FileWriter myWriter = new FileWriter("C:\\Users\\Lenovo\\Desktop\\file.txt");
            while (true) {
    ...
    private void printFile(){
        try{
            System.setIn(new FileInputStream("C:\\Users\\Lenovo\\Desktop\\file.txt"));
